              ...
              <div class="card card-primary">
                ...
                <form role="form" method="POST" action="{{route('buyer.update', $data[0]->id) }}">
                  ...
                  <div class="card-body">
                    ...
                    <input type="text" class="form-control" id="name" name="name" value="{{$data[0]->name}}" placeholder="Enter Supplier Name">
                      </div>
                      <div class="form-group">
                        <label for="address">Address</label>
                        <input type="text" class="form-control" id="address" name="address" value="{{$data[0]->address}}" placeholder="Enter Supplier Address">
                      </div>
                      <div class="form-group">
